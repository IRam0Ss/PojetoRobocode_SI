...
public class WaveSurfer {
    ...
    // Novo atributo para armazenar os pontos de debug da última decisão
    private ArrayList<DebugPoint> lastDecisionPoints = new ArrayList<>();
    // Para armazenar a melhor rota escolhida
    private DebugPoint chosenMoveDebug = null;
    ...
    public ArrayList<DebugPoint> getLastDecisionPoints() {
        return lastDecisionPoints;
    }

    public DebugPoint getChosenMoveDebug() {
        return chosenMoveDebug;
    }
